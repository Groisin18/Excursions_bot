...
class Validators:
    ...
    def validate_slot_time(time_str: str) -> time:
        ...
        # Нормализация часов: удаляем ведущие нули для последующего преобразования
        hour_int = int(hour)
    ...
    @staticmethod
    def validate_amount_rub(v: str | int | float) -> int:
    ...
    @staticmethod
    def validate_discount(v: str | int) -> int:
    ...
    @staticmethod
    def parse_virtual_phone(virtual_phone: str) -> tuple:
